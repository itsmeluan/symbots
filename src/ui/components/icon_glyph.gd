...
##
## Part slots render their authored SVGs instead; what is left here is the handful of symbols
## with no art file behind them — the two currencies and the four roles.
