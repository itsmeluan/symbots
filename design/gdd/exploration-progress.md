...
|---|---|---|
| **Save/Load** (#17) | The progression blob (Rule 8 split: this system owns blob semantics; Save/Load owns file format, timing, slots, disk I/O). Must list this system when authored, **and must explicitly resolve OQ-EP-2 (save-trigger granularity — the Player Fantasy contingency)**. | Not Started |
