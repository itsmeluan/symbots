...
| 10c | Enemy Level & Zone Scaling | World | MVP | In Review (2026-07-12, **round-2** full-panel /design-review — NEEDS REVISION → 6 blockers + 4 recommended fixed same session: Tuning Knobs 1.667→2.0 math error; economy 0.27/1,660 claim replaced with derived fight-distribution table (15/80/5 → ~0.34 Rares/victory, central ~1,800, mild-scarcity CONFIRMED); AC-11 +HIGH fixture; AC-05(D)→AC-ELZS-12; new EC/AC-ELZS-13 dangling enemy_id; AC-02 anti-hardcoding BOSS L3→130. CD committed APPROVE on fix-confirmation — re-review pending fresh session. 4 errata still owed on approval: Enemy DB/Encounter Zone/Drop+economy-model/ZWM) | design/gdd/enemy-level-zone-scaling.md | Enemy Database, Encounter Zone, Drop System, Zone & World Map |
