...
| 10b | Symbot Core Progression (Leveling) | Gameplay | MVP | Needs Revision (2026-07-13 fresh-session re-review — C-2/D-2 confirmed RESOLVED; 5 new spec/testability/tracking-hygiene blockers, in-doc fixes applied same session, confirmation re-review pending. CD: design is sound, no design-soundness issues. **3 cross-doc obligations owed before Approved:** (1) ELZS erratum absorbing the orphaned OQ-CP-8 Pillar-2 equip-gate AC; (2) Symbot Assembly erratum AC gating AC-CP-18 pipeline ordering; (3) Part DB/SA-F1 `cooling` output range to promote AC-CP-22 cooling check from ADVISORY-until-established to BLOCKING. In-doc DONE: logging-spy interface, AC-CP-21 discriminating fixture, OQ-CP-6 CD ratification recorded, OQ-CP-8 re-derivation.) | design/gdd/symbot-core-progression.md | Symbot Assembly, Part Database, Turn-Based Combat, Enemy Level & Zone Scaling |
