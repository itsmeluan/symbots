...
|---|-------------|----------|----------|--------|------------|------------|
| 1 | Part Database | Foundation | MVP | **Approved — Revision Pending** (2026-07-16, Round 10 full-panel /design-review [5 specialists + CD, headless standard-context] — NEEDS REVISION: 7 blockers. Directive violations: 5 EC↔AC citations missing, AC-09 clamp fixture non-discriminating. Contract gaps: Prototype Chassis focus off-by-one 28<29 vs Rare floor, Prototype ≥3-cond/≥×3.0 rule has no AC [breaks Drop-System pity calibration], `level_growth` `String`-vs-`StringName` key-type latent bug [CP-F3 would read 0], per-stat ≤55 cap unenforced [60→120 at +5], Rule 9 ×0.7 example contradicts Drop Rule 5a. CD: "surgical corrections, hours not redesign"; shipped implementation stands. Prior Round 9 status: Approved) | design/gdd/part-database.md | — |
