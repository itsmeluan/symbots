...
- [Core Progression AC Review](project-core-progression-ac-review.md) — Round 3 review; 4 new blockers (cooling ceiling undefined in AC-CP-22, AC-CP-18 DoD traceability gap, logging spy injection unspecified, OQ-CP-6 no enforcement AC)
...
- [Exploration Progress AC Draft](project-exploration-progress-ac-draft.md) — 15 BLOCKING unit ACs drafted for GDD #14; 4 GDScript traps called out; all 17 ECs mapped; 2 integration ACs DEFERRED pending Save/Load #17
